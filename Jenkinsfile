pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/m-gendi/go-demo-6') {
            checkout scm
            sh "make unit-test"
            sh "make linux"
          ...
          dir('/home/jenkins/go/src/github.com/m-gendi/go-demo-6/charts/preview') {
            sh "make preview"
    ...
    stage('Promote to Environments') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/m-gendi/go-demo-6/charts/go-demo-6') {
